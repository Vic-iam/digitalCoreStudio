...
export default function CashRegister() {
  ...
  async function addEntry(event: FormEvent<HTMLFormElement>) {
    ...
    if (cart.length === 0) {
      setError(
        "Agregá al menos un producto o servicio para registrar la venta.",
      );
      return;
    }
    try {
  ...
  return (
    <section className={`${styles.page} checkout-page`}>
      <header className="checkout-header">
        <div>
          <p className="eyebrow">Terminal de cobro</p>
          <h1>Venta rápida</h1>
          <p>
      ...
      <div className="checkout-layout">
        ...
        >
          <div className="panel-header">
            <div>
              ...
              <p className="panel-subtitle">
                Buscá y agregá productos o servicios.
              </p>
            </div>
          ...
          <label className="search-field">
            ...
            <input
              ...
              placeholder="Escribí el nombre y seleccioná para agregar..."
            />
          </label>
          {search && (
            <div className="service-results">
              {filteredServices.length === 0 ? (
                <span>No encontramos servicios.</span>
              ) : (
          ...
          <div className="cart-list">
            {cart.length === 0 ? (
              ...
              cart.map((service, index) => (
                <div className="cart-row" key={`${service.id}-${index}`}>
                  <div>
        ...
        <aside className="panel payment-queue">
          <div className="panel-header">
            <div>
              <h2>Cola de cobros</h2>
              <p className="panel-subtitle">Ventas pendientes de registrar</p>
            </div>
          ...
          <div className="queue-empty">
            ...
            <span>No hay ventas pendientes de cobro en este momento.</span>
          </div>
      ...
      <div className="panel daily-sales">
        <div className="panel-header">
          <div>
        ...
        {entries.length === 0 ? (
          <p className="empty-state">Todavía no hay ventas registradas.</p>
        ) : (
                  ...
                  <tr key={entry.id}>
                    <td>
                      ...
                      {entry.notes && (
                        <>
                          <br />
                          <small className="muted">{entry.notes}</small>
                        </>
                      )}
                    </td>
                    <td>{entry.client_name ?? "Consumidor final"}</td>
                    <td>
